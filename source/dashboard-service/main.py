...
from app.handlers import handle_measurement_event, get_state, get_state_by_source
...
def run_consumer() -> None:
    global consumer
    consumer = RabbitMQConsumer(RABBITMQ_EXCHANGE, [f"{RABBITMQ_REST_SENSORS_ROUTING_KEY}.#"], handle_measurement_event)
    consumer.connect()
